package io.github.anshireminder.app.data
...
import io.github.anshireminder.app.model.BuyingReminderSchedule
...
class SettingsRepository(private val context: Context) {
    ...
    val settingsFlow: Flow<SettingsState> = context.dataStore.data.map { prefs ->
        SettingsState(
            ...
            strongReminderEnabled = prefs[SettingsKeys.STRONG_REMINDER_ENABLED] ?: false,
    ...
    suspend fun saveSettings(settings: SettingsState) {
        context.dataStore.edit { prefs ->
            ...
            prefs[SettingsKeys.STRONG_REMINDER_ENABLED] = settings.strongReminderEnabled
