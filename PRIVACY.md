# 安时隐私政策 / Anshi Privacy Policy

## 中文

安时不会收集、存储到服务器、传输或分享任何个人信息、服药记录或其他用户数据。

应用不包含账号系统、广告、分析 SDK、崩溃报告服务或第三方跟踪技术。所有设置和服药记录均保存在用户设备本地。
...
Anshi does not collect, upload, transmit, or share personal information, pill records, or other user data.

The app contains no account system, advertising, analytics SDK, crash-reporting service, or third-party tracking technology. All settings and pill records are stored locally on the user's device.
